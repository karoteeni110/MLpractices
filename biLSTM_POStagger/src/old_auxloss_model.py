...
Original file is located at
    https://colab.research.google.com/drive/1XnNLC5JRHj3VAhdH8i11aht5y2CyMajz
"""
...
from old_data_ud import word_to_ix,byte_to_ix,char_to_ix,tag_to_ix,freq_to_ix,tag_to_freq,\
                    training_data,dev_data,test_data
torch.manual_seed(1)

# save_modelname = 'de_auxloss_w+c.model'

# my_src_path = '/content/drive/My Drive/Colab Notebooks/biLSTM/src'
# my_data_path = '/content/drive/My Drive/Colab Notebooks/biLSTM/data'
# import sys
# sys.path.append(my_src_path)
# sys.path.append(my_data_path)
...
if __name__ == "__main__":
    ...
    # checkpoint = torch.load('/content/drive/My Drive/Colab Notebooks/biLSTM/data/EP15_de_auxloss_w+c.model')
